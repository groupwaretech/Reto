...
class NavigationViewController : UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let item1 = NavigationModel(title: "Mi perfil", icon: "icon-home")
        let item2 = NavigationModel(title: "Comentarios", icon: "icon-chat", count: "3")
        let item3 = NavigationModel(title: "A quién ayudo", icon: "icon-star")
        let item4 = NavigationModel(title: "Ajustes", icon: "icon-filter")
        let item5 = NavigationModel(title: "Acerca del programa", icon: "icon-info")
